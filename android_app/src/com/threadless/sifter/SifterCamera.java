...
public class SifterCamera extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public SifterCamera(Activity activity, int cameraId, LayoutMode mode) {
        super(activity);
    ...
    private void doSurfaceChanged(int width, int height) {
         ...
         * surfaceChanged is called again due to the change of the layout size
        ...
        if (!mSurfaceConfiguring) {
             ...
             * recursively. Recursive call of surfaceChanged is very special
             * case, which is a path from the catch clause at the end of this
             * method.
             * 
             * The later part of this method should be executed as well in the
             * recursive invocation of this method, because the layout change
             * made in this recursive call will not trigger another invocation
             * of this method.
             */
    ...
    protected Camera.Size determinePreviewSize(boolean portrait, int reqWidth,
         ...
         * while it is the same as user's view for surface and metrics. That is,
         * width must always be larger than height for setPreviewSize.
         */
